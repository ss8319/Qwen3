...
# Configuration
# -------------------------------------------------------------------------
JSON_INPUT_FILE = 'data/ClinicalContext_MCQA_part2.json'
CSV_INPUT_FILE = 'data/textbook_IIYI_PubMed.csv'
JSON_OUTPUT_FILE = 'data/enhanced/ClinicalContext_MCQA_part2.json'
PROGRESS_FILE = 'progress_ClinicalContext_MCQA_part2.json'
SKIPPED_FILE = 'skipped_questions_ClinicalContext_MCQA_part2.jsonl'
ERROR_LOG_FILE = 'enhancement_errors_ClinicalContext_MCQA_part2.log'
BATCH_SIZE = 4
